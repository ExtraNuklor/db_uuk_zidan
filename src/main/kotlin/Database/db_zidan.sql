...
(2, 'kasir1', 'password', 'medioker', 'kasir');
...
INSERT INTO `transaksi` (`id_transaksi`, `id_petugas`, `id_barang`, `id_pelanggan`, `tanggal`, `jumlah`, `total_harga`) VALUES
(3, 1, 1, 1, '2024-05-22', 2, 2000),
(4, 1, 1, 1, '2024-05-22', 6, 6000);
