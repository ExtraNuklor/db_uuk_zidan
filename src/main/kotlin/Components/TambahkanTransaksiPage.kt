...
@Composable
fun TambahkanTransaksiPage(navController: NavController) {
            ...
            Column(
                ...
                Column(
                    ...
                    Column(
                        ...
                        Button(
                            onClick = {
                                crud.tambahkanTransaksi(
                                    id_barang = barangList[itemPositionBarang.value]["id_barang"].toString(),
                                    id_pelanggan = pelangganList[itemPositionPelanggan.value]["id_pelanggan"].toString(),
                                    id_petugas = Session.userId.toString(),
                                    jumlah = stokDibeli.value.toString(),
                                    totalHarga = totalHarga.value.toString()
                                )
                                navController.popBackStack()
                            }
                        ) {
